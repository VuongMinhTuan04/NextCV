    ...
    <header className="fixed left-0 top-0 z-50 w-full border-b border-slate-200 bg-[#F8FAFC]/95 backdrop-blur-md">
      <div className="relative mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        <HeaderDesktop search={search} setSearch={setSearch}
          results={results} mobileSearchOpen={mobileSearchOpen} onHomeClick={handleHomeClick}
        />

        <HeaderMobile search={search} setSearch={setSearch} results={results}
          mobileSearchOpen={mobileSearchOpen} setMobileSearchOpen={setMobileSearchOpen}
          mobileSearchRef={mobileSearchRef} mobileSearchInputRef={mobileSearchInputRef}
          closeMobileSearch={closeMobileSearch} onHomeClick={handleHomeClick}
        />

        <HeaderRight mobileSearchOpen={mobileSearchOpen} />
      </div>

      <MobileSearchResult mobileSearchOpen={mobileSearchOpen} results={results}
        search={search} onSelectUser={handleSelectUser}
      />
    </header>
  )
}
